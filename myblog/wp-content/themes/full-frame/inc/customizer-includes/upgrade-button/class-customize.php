 ...
 * @access public
 */
final class full_frame_upgrade_pro_customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'full_frame_upgrade_pro_customize_section_pro' );

		// Register sections.
		$manager->add_section(
			new full_frame_upgrade_pro_customize_section_pro(
				$manager,
				'upgrade_button',
				array(
					'title'    => esc_html__( 'Full Frame Pro', 'full-frame' ),
					'pro_text' => esc_html__( 'Upgrade Now', 'full-frame' ),
					'pro_url'  => 'https://catchthemes.com/themes/full-frame-pro',
					'priority' => 1
				)
			)
		);
...
full_frame_upgrade_pro_customize::get_instance();
